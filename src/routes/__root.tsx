...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Agents Space" },
      { name: "description", content: "AI Agents, Chatbots & Voice Automation" },
      { property: "og:title", content: "Agents Space" },
      { name: "twitter:title", content: "Agents Space" },
      { property: "og:description", content: "AI Agents, Chatbots & Voice Automation" },
